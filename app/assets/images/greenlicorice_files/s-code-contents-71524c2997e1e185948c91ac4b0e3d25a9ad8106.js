...
if (typeof s_linkInternalFiltersAppend == "undefined") s_linkInternalFiltersAppend = '';
s.linkInternalFilters = "javascript:,vitacost.com,lef.com,toxicrelief.com,twinlabvitamins.com,vitamins-supplements.net,vitaminsforcancer.com,paypal.com" + s_linkInternalFiltersAppend;
...
s.Media.trackVars = "eVar47,eVar48,eVar49,prop42";
s.Media.trackEvents = "event30,event31,event32,event33,event34,event35,event36";
...
*/
   ...
   /* Plugin Config */
    ...
    function s_doPlugins(s) {
     // console.log('doPluginsFired');
    /* Add calls to plugins here */
    if (s && s.purchaseID) { s.eVar54 = s.purchaseID.toString(); }
    }
...
/*
* Plugin: omnitureBaazaarvoice - Depends on ratingsDisplayed function defined before
*              the bazaarvoice code (for review collection).
*/
s.omnitureBazaarvoice = new Function("p", "owr", ""
+ "var list='type,client,landing,product,link';"
+ "s=this,qs='bv';prm=s.Util.getQueryParam(qs);if(typeof(omnitureReview"
