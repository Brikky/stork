...
brandon = User.create(first_name: 'brandon', last_name: 'admin', email: 'brandon@admin.com', password: '123456', full_address: Faker::Address.street_address + Faker::Address.city + Faker::Address.state + Faker::Address.zip.to_s + Faker::Address.country)
...
Order.all.each{|o| o.handle_payment}
